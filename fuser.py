...
"""
This module contains functions for fusing multiple channels of a meter into a single channel.
...
def make_valid_fusers() -> Dict[
    ...
    """
    Make a dictionary of valid fusers that are in this module.

    Returns
    -------
    dict of {str: callable}
        A new dictionary of valid fusers as defined in this module.
    """
    valid_fusers = {
...
def run_cross_func(
    ...
    **kwargs: Mapping[str, Any]
    ...
    """
    Fuse the data by using the cross product between the channels and some new data generated by
    applying a component-wise function to the original channels.
...
def run_cross_time(
    ...
    **kwargs: Mapping[str, Any]
    ...
    # pylint: disable=too-many-locals,
    """
    Fuse the data by using the cross product between the vectors v(t) and v(t - 1), where v(*)
...
def run_mean(
    ...
    **kwargs: Mapping[str, Any]
    ...
    """
    Fuse the data by using the mean of the channels.
